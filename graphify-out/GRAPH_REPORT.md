...
## Corpus Check
- 79 files · ~297,186 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1220 nodes · 1659 edges · 101 communities (84 shown, 17 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 185 edges (avg confidence: 0.71)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1691bc97`
...
Cohesion: 0.05
Nodes (44): api_login(), api_premium_setpassword(), auth_nc_admin(), nginx auth_request endpoint. Returns 200 if caller is a Nextcloud admin, 401 oth, nginx auth_request endpoint. Returns 200 if caller is a Nextcloud admin, 401 oth, _add_to_talk_rooms(), api_login(), api_logout() (+36 more)

### Community 2 - "Community 2"
Cohesion: 0.07
Nodes (28): ADSBAirAssetPoller, alert_leo_aircraft(), alert_orbit(), check_orbit(), ensure_schema(), fetch_aircraft(), _heading_delta(), _km() (+20 more)

### Community 3 - "Community 3"
Cohesion: 0.05
Nodes (33): _banner_api(), _check_commute_alerts(), clear_banner(), create_deck_card(), _point_to_segment_distance_miles(), post_banner(), modules/alerts.py — Banners, Deck cards, and commute alerts.  Moved here from mo, Create a Deck card in the New column when a new incident is detected. (+25 more)
...
Cohesion: 0.07
Nodes (38): api_tgid_confirm(), Manually confirm a TGID name and write it to the tags TSV., Manually confirm a TGID name and write it to the tags TSV., _room_for_call(), analyze_for_incident(), _consider_hold(), _create_incident(), _detect_escalation_stage() (+30 more)
...
Cohesion: 0.08
Nodes (14): BasePoller, APDCADPoller, _parse_cad_ts(), modules/pollers/impl/apd_cad.py ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ Austin PD CAD r, Fetch CAD records from the lookback window and upsert them., Match unmatched CAD rows to scanner incidents and harvest TGID hints., Poll APD CAD records every six hours and enrich matching incidents., Create APD CAD and TGID hint tables if they do not exist. (+6 more)
...
Cohesion: 0.12
Nodes (19): api_calls(), api_flagged_incidents(), api_incidents(), api_incidents_active(), bot_talk(), Return all flagged incidents., Return all flagged incidents., Inject a synthetic call for pipeline testing — bypasses Whisper. (+11 more)

### Community 22 - "Community 22"
Cohesion: 0.11
Nodes (13): APDNewsPoller, Poll Google News RSS for APD press releases every 5 minutes.      State is held, Return a human-readable status string for health checks and tests., BasePoller, Abstract poller that runs run() in a daemon thread every `interval` seconds., Start the background polling thread., Signal the loop to stop and wait for the thread to finish., APDNewsPoller must be importable from modules.pollers (the package). (+5 more)
...
Cohesion: 0.16
Nodes (15): api_commute_save(), api_commute_time(), api_intel_query(), api_logout(), api_me(), api_premium_atak_status(), api_premium_citizen_intel(), api_premium_homicides_summary() (+7 more)

### Community 25 - "Community 25"
Cohesion: 0.13
Nodes (9): api_sitrep(), api_voice_sitrep(), Returns a clean, natural-language spoken sitrep for TTS., Returns a clean, natural-language spoken sitrep for TTS., build_sitrep(), build_voice_sitrep(), modules/sitrep.py ~~~~~~~~~~~~~~~~~ Situation report formatters., Unit tests for modules/sitrep.py. (+1 more)
...
Cohesion: 0.21
Nodes (12): _austin_events_format(), _austin_events_load(), _austin_events_post_to_talk(), _austin_events_state_load(), _austin_events_state_save(), austin_events_thread(), _austin_events_upcoming(), create_deck_card() (+4 more)
...
Cohesion: 0.2
Nodes (10): apd_news_thread(), _apd_parse_rss(), _match_article_to_incident(), Parse Google News RSS feed; return list of {title, link}., Try to resolve the real article URL via the source site's RSS feed.     Falls ba, Try to match a news article to a recent radio-detected incident.     Returns (in, Insert a row into incident_articles and update incidents.article_url., Poll APD press release page for new homicide/shooting announcements. (+2 more)
...
Cohesion: 0.25
Nodes (8): _atxfloods_post_to_talk(), atxfloods_thread(), _cad_fetch_and_store(), _fetch_url_with_retry(), Fetch CAD records from the last 14 days and upsert into apd_cad., Fetch a URL with exponential backoff retry.      Returns the response body as by, Poll ATXFloods and alert on state transitions (first sighting silent)., Fetch CAD records from the last 14 days and upsert into apd_cad.

### Community 47 - "Community 47"
Cohesion: 0.25
Nodes (8): apd_cad_thread(), _cad_init_db(), _cad_match_and_harvest(), Match unmatched CAD records against scanner incidents.     On match: enrich the, Create apd_cad and tgid_sector_hints tables if they don't exist., Match unmatched CAD records against scanner incidents.     On match: enrich the, Retrospective CAD enrichment — poll every 6 hours, match and harvest., Create apd_cad and tgid_sector_hints tables if they don't exist.
...
Cohesion: 0.33
Nodes (6): _export_incident_snapshot(), _nc_upload(), Upload a file to Nextcloud via WebDAV., Upload a file to Nextcloud via WebDAV., Build a markdown snapshot of a flagged incident and push to Nextcloud., Build a markdown snapshot of a flagged incident and push to Nextcloud.
...
Cohesion: 0.33
Nodes (6): Score a reddit post against incidents within ±4h. Returns (incident_id, score) o, Re-check investigating tips against radio calls and incidents. Marks matched / n, Score a reddit post against incidents within ±4h. Returns (incident_id, score) o, Re-check investigating tips against radio calls and incidents. Marks matched / n, _reddit_match_incident(), _reddit_tip_recheck()

### Community 56 - "Community 56"
Cohesion: 0.33
Nodes (6): _extract_tip_location(), _nominatim_geocode(), Geocode a free-form Austin string. Returns (lat, lon) or (None, None)., Extract a location from a Reddit post. Returns (location_str, lat, lon) or (None, Geocode a free-form Austin string. Returns (lat, lon) or (None, None)., Extract a location from a Reddit post. Returns (location_str, lat, lon) or (None
...
Cohesion: 0.4
Nodes (5): _banner_api(), clear_banner(), post_banner(), Post a site-wide breaking banner for serious incidents., Remove the site-wide banner when an incident clears.

### Community 60 - "Community 60"
Cohesion: 0.4
Nodes (5): Map traffic issue_reported string to a BB itype., Poll Austin Open Data for active traffic incidents and cross-reference with scan, Map traffic issue_reported string to a BB itype., _traffic_issue_to_itype(), traffic_open_data_thread()
...
Cohesion: 0.5
Nodes (4): _apd_fetch_article(), _pi_fetch(), Fetch a news article URL (follows redirects), extract address and description., Fetch a URL via the Pi5 fetch agent (residential IP, browser headers).     Retur

### Community 65 - "Community 65"
Cohesion: 0.67
Nodes (3): api_daily_summary(), Public daily summary of incidents bucketed by confidence tier.      Confidence t, Public daily summary of incidents bucketed by confidence tier.      Confidence t

### Community 66 - "Community 66"
Cohesion: 0.67
Nodes (3): api_backlog_claim(), Compatibility endpoint for external backlog workers.     Current pipeline is pus, Compatibility endpoint for external backlog workers.     Current pipeline is pus

### Community 67 - "Community 67"
Cohesion: 0.67
Nodes (3): api_tgid_guesses(), Return all TGID identification guesses, grouped by tgid., Return all TGID identification guesses, grouped by tgid.

### Community 68 - "Community 68"
Cohesion: 0.67
Nodes (3): api_shooting_intel(), Public endpoint: shooting incidents with transcript evidence, last 30 days., Public endpoint: shooting incidents with transcript evidence, last 30 days.

### Community 69 - "Community 69"
Cohesion: 0.67
Nodes (3): Verify Nextcloud Talk bot HMAC-SHA256 signature., Verify Nextcloud Talk bot HMAC-SHA256 signature., _verify_bot_signature()

### Community 70 - "Community 70"
Cohesion: 0.67
Nodes (3): api_flag_incident(), Flag an incident and export a snapshot to Nextcloud., Flag an incident and export a snapshot to Nextcloud.

### Community 71 - "Community 71"
Cohesion: 0.67
Nodes (3): premium_headlines(), Return incident_articles linked in the last 24h for the Headlines panel., Return incident_articles linked in the last 24h for the Headlines panel.

### Community 72 - "Community 72"
Cohesion: 0.67
Nodes (3): Receive Pi watchdog events and forward as Talk DM alerts., Receive Pi watchdog events and forward as Talk DM alerts., watchdog_event()

### Community 73 - "Community 73"
Cohesion: 0.67
Nodes (3): _load_active_incidents_from_db(), On startup, reload active incidents into _active_incidents so _release_stale can, On startup, reload active incidents into _active_incidents so _release_stale can

### Community 74 - "Community 74"
Cohesion: 0.67
Nodes (3): api_stats(), 24-hour summary stats for the splash page., 24-hour summary stats for the splash page.

### Community 75 - "Community 75"
Cohesion: 0.67
Nodes (3): premium_commute(), Live commute map — premium-gated or token-gated., Live commute map — premium-gated or token-gated.

### Community 76 - "Community 76"
Cohesion: 0.67
Nodes (3): api_commute_polyline(), Return encoded polyline for user's commute route. Auth via session or share toke, Return encoded polyline for user's commute route. Auth via session or share toke

### Community 77 - "Community 77"
Cohesion: 0.67
Nodes (3): api_drone_sightings(), Return recent drone sightings (last 24h by default, ?hours=N to override)., Return recent drone sightings (last 24h by default, ?hours=N to override).

### Community 78 - "Community 78"
Cohesion: 0.67
Nodes (3): pi_commands(), Pi polls this endpoint for pending commands (restart_op25, etc.)., Pi polls this endpoint for pending commands (restart_op25, etc.).

### Community 79 - "Community 79"
Cohesion: 0.67
Nodes (3): api_adsb(), Return current aircraft positions + 30-min trails grouped by icao24., Return current aircraft positions + 30-min trails grouped by icao24.

### Community 80 - "Community 80"
Cohesion: 0.67
Nodes (3): api_commute_incidents(), Return active incidents near the user's commute route. Auth via session or share, Return active incidents near the user's commute route. Auth via session or share

### Community 81 - "Community 81"
Cohesion: 0.67
Nodes (3): api_commute_share_token(), Generate or return existing share token for the user's commute map., Generate or return existing share token for the user's commute map.

### Community 82 - "Community 82"
Cohesion: 0.67
Nodes (3): api_drone_sighting(), Receive a drone sighting from the DroneRID Android app., Receive a drone sighting from the DroneRID Android app.

### Community 84 - "Community 84"
Cohesion: 0.67
Nodes (3): Post a traffic incident to the incidents Talk room., Post a traffic incident to the incidents Talk room., _traffic_post_to_talk()

## Knowledge Gaps
- **397 isolated node(s):** `Return the most recent occurred_date we have for this source.`, `Placeholder for TCSO live jail roster.     The SIPS SOAP endpoint (public.travis`, `Given a booking case number, find any radio incidents within ±4 hours     on the`, `Pretty-print a table using tabulate if available, else simple format.`, `Show overall system statistics.` (+392 more)
...
- **Why does `BasePoller` connect `Community 22` to `Community 33`, `Community 2`, `Community 34`, `Community 4`, `Community 38`, `Community 7`, `Community 8`, `Community 41`, `Community 42`, `Community 10`, `Community 14`, `Community 15`, `Community 20`, `Community 53`, `Community 26`, `Community 30`?**
  _High betweenness centrality (0.305) - this node is a cross-community bridge._
- **Why does `_nc_create_user()` connect `Community 1` to `Community 4`?**
  _High betweenness centrality (0.144) - this node is a cross-community bridge._
- **Why does `RedditIntelPollerTests` connect `Community 4` to `Community 22`?**
