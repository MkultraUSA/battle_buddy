...
from modules.incident_engine import _fts_connect, _fts_keepalive_thread, _atak_resync_thread
...
def receive():
    ...
    if is_duplicate(__import__("hashlib").sha256(wav_bytes).hexdigest()):
