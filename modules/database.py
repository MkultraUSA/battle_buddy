"""
Battle Buddy — SQLite database helpers.

All DB access for calls, incidents, subscriptions, and related tables
lives here. Depends only on stdlib and modules/constants.py — never
imports from audio_receiver.py to avoid circular imports.
"""
...
from modules.constants import DB_PATH, CAT_COORDS
